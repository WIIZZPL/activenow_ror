class SubjectsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @subject.update(subject_params)
        format.html { redirect_to subjects_path, notice: "Subject was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    if @subject.courses.count > 0
      ...
      redirect_to subjects_path, alert: "Cannot destroy a subject with existing courses"
