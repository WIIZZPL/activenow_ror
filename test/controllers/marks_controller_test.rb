...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference("Mark.count") do
      post marks_url, params: { mark: { course_id: @mark.course_id, desc: @mark.desc, exam_id: @mark.exam_id, student_id: @mark.student_id, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { course_id: @mark.course_id, desc: @mark.desc, exam_id: @mark.exam_id, student_id: @mark.student_id, value: @mark.value } }
